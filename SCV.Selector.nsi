...
!endif
!define RELEASE_DATE "2011.03.24"
...
Function RegFix
  ...
  ${If} $RegFix >= 1
    ...
    # Rainbow or washed out colors fix on WinVista up for 1.16.1
    ${If} ${AtLeastWinVista}
      ${If} ${RunningX64}
        WriteRegStr HKLM "SOFTWARE\Wow6432Node\Microsoft\DirectDraw\Compatibility\StarCraft116" "Name" "StarCraft.exe"
        WriteRegBin HKLM "SOFTWARE\Wow6432Node\Microsoft\DirectDraw\Compatibility\StarCraft116" "ID" ca896549
        WriteRegBin HKLM "SOFTWARE\Wow6432Node\Microsoft\DirectDraw\Compatibility\StarCraft116" "Flags" 00080000
      ${Else}
        WriteRegStr HKLM "SOFTWARE\Microsoft\DirectDraw\Compatibility\StarCraft116" "Name" "StarCraft.exe"
        WriteRegBin HKLM "SOFTWARE\Microsoft\DirectDraw\Compatibility\StarCraft116" "ID" ca896549
        WriteRegBin HKLM "SOFTWARE\Microsoft\DirectDraw\Compatibility\StarCraft116" "Flags" 00080000
      ${EndIf}
    ${EndIf}
